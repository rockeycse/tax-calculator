function part1(input_year, input_area) {
    ...
    if (input_area_part1 <= 25) {
        ...
        return [hall_dabi, bakeya, interest, total, onnano];
    }
    else {
...
function part2(input_year, input_area) {
    ...
    if (input_area_part2 <= 200) {
        ...
        var bakeya = hall_dabi * year_part2;
        var total = (hall_dabi * (Math.pow((1 + .0625), (year_part2 + 29)) - Math.pow((1 + .0625), 29))) / 0.0625;
        var interest = total - (hall_dabi + bakeya);
        var onnano = 0;
...
function part7(input_year, input_area) {
    ...
    if (year_Part7 == 0) {
        if (year_Part7 <= 825) {
            ...
            satangso = 2;
            hall_dabi = input_area_Part7 * satangso;
            bakeya = hall_dabi * year_Part7;
            total = (hall_dabi * (Math.pow((1 + .0625), (year_Part7 + 1)) - 1)) / 0.0625;
            interest = total - bakeya;
            onnano = 0;
            return [hall_dabi, bakeya, interest, total, onnano];
        }
    }
    if (year_Part7 == 1) {
        if (year_Part7 <= 825) {
            hall_dabi = 10;
            bakeya = 10 * year_Part7;
            total = (hall_dabi * (Math.pow((1 + .0625), (year_Part7 + 21)) - Math.pow((1 + .0625), 21))) / 0.0625;
            interest = total - bakeya;
            onnano = total;
            ...
            var total = (hall_dabi * (Math.pow((1 + .0625), (year_Part7 + 21)) - Math.pow((1 + .0625), 21))) / 0.0625;
            var interest = total - bakeya;
            var onnano = 0;
            return [hall_dabi, bakeya, interest, total, onnano];
        }
...
function part71(input_year, input_area) {
    ...
    if (year_Part71 == 1) {
        ...
        var hall_dabi = area_Part71 * satangso;
        var bakeya = hall_dabi * year_Part71;
        var total = (hall_dabi * (Math.pow((1 + .0625), (year_Part71 + 21)) - Math.pow((1 + .0625), 21))) / 0.0625;
        var interest = total - bakeya;
        var onnano = 0;
    ...
    if (input_year > 1423) {
        ...
        if (input_area > 0 && input_area !== null) {
            if (input_year == 1423) {
                ...
                var interest = pa7[2] + pa6[2] + pa5[2];
                ...
                interest = pa7[2] + pa6[2] + pa5[2] + pa4[2];
                ...
                interest = pa7[2] + pa6[2] + pa5[2] + pa4[2] + pa3[2];
                ...
                interest = pa7[2] + pa6[2] + pa5[2] + pa4[2] + pa3[2] + pa2[2];
                ...
                interest = pa7[2] + pa6[2] + pa5[2] + pa4[2] + pa3[2] + pa2[2] + pa1[2];
        ...
        if (areaBanijjo > 0) {
            ...
            if (input_year == 1423) {
                ...
                hall_dabi1 = pa71[0];
                bakeya1 = pa71[1] + pa6[1];
                interest1 = pa71[2] + pa6[2];
                total1 = pa71[3] + pa6[3];
                onnano1 = pa71[4] + pa6[4];
                ...
                hall_dabi1 = pa81[0];
                bakeya1 = pa71[1] + pa6[1] + pa5[1];
                interest1 = pa71[2] + pa6[2] + pa5[2];
                total1 = pa71[3] + pa6[3] + pa5[3];
                onnano1 = pa71[4] + pa6[4] + pa5[4];
                ...
                hall_dabi1 = pa71[0];
                bakeya1 = pa71[1] + pa6[1] + pa5[1] + pa4[1];
                interest1 = pa71[2] + pa6[2] + pa5[2] + pa4[1];
                total1 = pa71[3] + pa6[3] + pa5[3] + pa4[1];
                onnano1 = pa71[4] + pa6[4] + pa5[4] + pa4[1];
                ...
                hall_dabi1 = pa71[0];
                bakeya1 = pa71[1] + pa6[1] + pa5[1] + pa4[1] + pa3[1];
                interest1 = pa71[2] + pa6[2] + pa5[2] + pa4[1] + pa3[1];
                total1 = pa71[3] + pa6[3] + pa5[3] + pa4[1] + pa3[1];
                onnano1 = pa71[4] + pa6[4] + pa5[4] + pa4[1] + pa3[1];
                ...
                interest1 = pa71[2] + pa61[2] + pa51[2] + pa41[2] + pa31[2] + pa21[2];
                ...
                interest1 = pa71[2] + pa61[2] + pa51[2] + pa41[2] + pa31[2] + pa21[2] + pa11[2];
        ...
        total_interest = interest + interest1;
        total_onnanno = onnano + onnano1;
        grand_total = total + total1;
        //var Grand_total = total + total_onnanno + total_interest;
        ...
        var a3 = '<tr class="success"><td style="font-family: SolaimanLipi; border-left:3px solid black; text-align:center; font-size:20px;">সুদ</td><td style="font-family: SolaimanLipi; border-left:3px solid black; text-align:center; font-size:20px; background:#235A01; color:white;">' + Math.round(total_interest * Math.pow(10, 2)) / Math.pow(10, 2) + '</td></tr>';
